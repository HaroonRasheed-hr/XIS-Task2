...
class ImageViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        """Return images only for the authenticated user"""
    ...
    def create(self, request, *args, **kwargs):
        """Handle image upload - only authenticated users"""
        ...
        # Create image object associated with current user
    ...
    def delete_image(self, request, pk=None):
        """Delete an image - only the owner can delete"""
